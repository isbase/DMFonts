...
#import "DownLoadFontController.h"

@interface DownLoadFontController ()

@end

@implementation DownLoadFontController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"可用中文字体";
}
